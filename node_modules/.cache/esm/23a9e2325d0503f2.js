let checkLoginType,checkLoginExistences,checkUserEmail;_5d0‍.w("../app/assets/js/scripts",[["checkLoginType",["checkLoginType"],function(v){checkLoginType=v}],["checkLoginExistences",["checkLoginExistences"],function(v){checkLoginExistences=v}],["checkUserEmail",["checkUserEmail"],function(v){checkUserEmail=v}]]);//Scripts and aux plugin
  ...
  if ( login ) {
    ...
    try {
      ...
      if( type ){
        ...
        _5d0‍.g.console.log(" Login existense : "+user)

        if( user ){

          email = checkUserEmail(user.id);
          _5d0‍.g.console.log(" email existense : "+user)
