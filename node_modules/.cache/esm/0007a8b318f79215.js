...
exports.login = async ( req, reply ) => {
  ...
  if( login && password ) { 
    ...
    _18f‍.g.console.log("Login type: "+login_type+"\n");

    if ( login_type ) {
    
      const user_existence = await testeController.checkLoginExistences( login, login_type ); 
      _18f‍.g.console.log(user_existence);
      _18f‍.g.console.log("user_existence: "+user_existence+"\n" );
      ...
      if ( user_existence ) {
        ...
        _18f‍.g.console.log("password_existence: "+password_existence+"\n");
        
        if ( password_existence ) {

          const user_existense = password_existence;
          await creatToken(user_existense.id);
          _18f‍.g.console.log("O usuario existe "+creatToken(user_existence.id));
          ...
          _18f‍.g.console.log("Password not existense "+ user_existence +"\n");
        ...
        _18f‍.g.console.log("User not existense "+ user_existence +"\n");
